...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.Pilot Pilot}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PilotField<FieldT >
    extends EntityField<Pilot, FieldT>
    implements PilotSelectable
{
     ...
     */
    public PilotField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PilotField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
