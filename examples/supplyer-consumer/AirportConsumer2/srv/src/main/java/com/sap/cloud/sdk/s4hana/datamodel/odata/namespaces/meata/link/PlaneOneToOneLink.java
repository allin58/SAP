...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.Plane Plane} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.link.PlaneLink PlaneLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class PlaneOneToOneLink<ObjectT extends VdmObject<?> >
    extends PlaneLink<ObjectT>
    implements OneToOneLink<Plane, ObjectT>
{
     ...
     */
    public PlaneOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Plane> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Plane>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
