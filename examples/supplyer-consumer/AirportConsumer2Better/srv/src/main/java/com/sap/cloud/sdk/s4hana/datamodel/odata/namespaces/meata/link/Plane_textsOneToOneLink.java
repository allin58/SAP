...
/**
 * Template class to represent entity navigation links of {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.Plane_texts Plane_texts} to other entities, where the cardinality of the related entity is at most 1. This class extends {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.link.Plane_textsLink Plane_textsLink} and provides an additional filter function.
 * @param <ObjectT>
 * Entity type of subclasses from {@link com.sap.cloud.sdk.s4hana.datamodel.odata.helper.VdmObject VdmObject}.
 * 
 */
public class Plane_textsOneToOneLink<ObjectT extends VdmObject<?> >
    extends Plane_textsLink<ObjectT>
    implements OneToOneLink<Plane_texts, ObjectT>
{
     ...
     */
    public Plane_textsOneToOneLink(final String fieldName) {
        super(fieldName);
    }
    ...
    @Nonnull
    @Override
    public ExpressionFluentHelper<Plane_texts> filter(
        @Nonnull
        ...
        return new ExpressionFluentHelper<Plane_texts>((new FilterExpressionWrapper<>(getFieldName() + "/" + filterExpression.getExpression().getFieldName(),filterExpression.getExpression().getOperator(),filterExpression.getExpression().getValue())));
    }
