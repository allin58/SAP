...
/**
 * Template class to represent entity fields of the Entity {@link com.sap.cloud.sdk.s4hana.datamodel.odata.namespaces.meata.Plane Plane}. Instances of this object are used in query modifier methods of the entity
 ...
 * 
 */
public class PlaneField<FieldT >
    extends EntityField<Plane, FieldT>
    implements PlaneSelectable
{
     ...
     */
    public PlaneField(final String fieldName) {
        super(fieldName);
    }
     ...
     *     OData field name. Must match the field returned by the underlying OData service.
     */
    public PlaneField(final String fieldName, final TypeConverter<FieldT, ?> typeConverter) {
